...
import {currentPosition} from '../service/geolocationService';
...
export default class Map extends Component {
    ...
    componentDidMount() {
        currentPosition(this.updateCurrentPosition);
    }
    ...
    onRegionChange(region) {
        ...
        if (left < LEFT || right > RIGHT || bot < BOT || top > TOP) {
            this.setState({region: this.neverChangingRegion});
            return;
        }
